...
public class MadLibs {
    ...
    public void enterNoun3() {
        System.out.println("Please provide the last noun!");
    ...
    public void enterAdverb() {
        System.out.println("Please provide an adverb!");
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
        story = "Jesse and her best friend " + getName() + " went to a Disney World "
                + "today! They saw a " + getNoun1() + " in a show at the Magic "
                + "Kingdom and ate a " + getAdjective1() + " feast for dinner. "
                + "The next day I ran " + getAdverb() + " to meet Mickey Mouse "
                + "in his " + getNoun2() + " and then that night I gazed at the "
                + getRandomNums() + " " + getAdjective2() + " fireworks "
                + "shooting from the " + getNoun3() + "."; 
        } else {
            story = "Amanda and her frenemy " + getName() + " went to the zoo "
                + "last summer. They saw a huge " + getNoun1() + " and a tiny "
                + "litte " + getNoun2() + ". That night they decided to climb " 
                + getAdverb() + " into the " + getNoun3() + " to get a closer "
                + "look. The zoo was " + getAdjective1() + " at night, but "
                + "they didn't care... until " + getRandomNums() + " " 
